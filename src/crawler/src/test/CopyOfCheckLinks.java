...
import crawler.ISpiderReportable;
...
public class CopyOfCheckLinks extends javax.swing.JFrame implements
             Runnable,ISpiderReportable {
  /**
   * The constructor. Perform setup here.
   */
public CopyOfCheckLinks()
  {
    //{{INIT_CONTROLS
  ...
  {
    (new CopyOfCheckLinks()).setVisible(true);
  }
  /**
   * Add notifications.
   */
...
class SymAction implements java.awt.event.ActionListener {
  ...
  public void run()
  {
    try {
      errors.setText("");
      spider = new Spider(this, badLinksCount, null, null);
      spider.clear();
      base = new URL(url.getText());
      spider.addURL(base, base);
      spider.begin();
  ...
  public boolean spiderFoundURL(URL base,URL url)
  {
    ...
    goodLinksCount++;
//    return Filter.urlFilter(url);
	return frameSizeAdjusted;
  }
  /**
